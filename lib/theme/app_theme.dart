...
final lightTheme = ThemeData(
  ...
  extensions: const <ThemeExtension<dynamic>>[
    TWColors(
        ...
        defaultWidgetBackgroundColor: Color(0xFFFFFFFF),
...
final darkTheme = ThemeData(
  ...
  extensions: const <ThemeExtension<dynamic>>[
    TWColors(
        ...
        dialogBackgroundColor: Color(0xFF171717),
        dividerBackgroundColor: Color(0xFF262626),
        inputBackgroundColor: Color(0xFF404040),
        strokeBackgroundColor: Color(0xFF404040),
        defaultWidgetBackgroundColor: Color(0xFF262626),
